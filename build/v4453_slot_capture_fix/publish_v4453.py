...
def main() -> None:
    ...
    require("document.querySelector('#agendaDate')||box?.querySelector" in app_text,'No usa agendaDate global')
    require("document.querySelector('#agendaTime')||box?.querySelector" in app_text,'No usa agendaTime global')

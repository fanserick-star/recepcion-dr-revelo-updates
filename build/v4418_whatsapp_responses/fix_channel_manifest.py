...
VERSION='4.4.18'
# El launcher 4.3.100 instalado valida explícitamente este prefijo /main/.
# La integridad sigue protegida por SHA-256 para cada archivo.
...
print('V4418_CHANNEL_MANIFEST_OK ref=main launcher_compat=1')

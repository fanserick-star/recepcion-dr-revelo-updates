...
.brand-box{{
  height:38mm;border:1px solid #8fb3aa;border-radius:3mm;display:grid;
  grid-template-columns:28mm 1fr 20mm;align-items:center;gap:2mm;padding:2.5mm 4mm;
...
.brand-logo{{width:23mm;height:23mm;object-fit:contain;justify-self:center;position:relative;z-index:2}}
.brand-copy{{text-align:center;position:relative;z-index:2}}
.brand-copy h1{{margin:0;font-size:18pt;line-height:1;font-weight:900;letter-spacing:.2px}}
.brand-copy h2{{margin:1mm 0 0;font-size:15pt;line-height:1;font-weight:900}}
.senescyt{{margin-top:1.5mm;font-family:Georgia,serif;font-size:9.2pt;font-weight:700}}
.services{{margin-top:1mm;font-family:Georgia,serif;font-size:8.7pt;font-weight:700;line-height:1.08}}
.cert-title{{margin:8mm 0 0;text-align:center;font-family:Georgia,serif;color:var(--navy);font-size:17pt;font-weight:900;letter-spacing:.4px}}

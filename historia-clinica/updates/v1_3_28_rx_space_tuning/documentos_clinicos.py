...
.sheet{{
  width:210mm;height:210mm;margin:0 auto;background:white;display:grid;
  grid-template-columns:105mm 105mm;overflow:hidden;box-shadow:0 8px 28px #0f172a2c;
}}
.rx-copy{{
  width:105mm;height:210mm;position:relative;overflow:hidden;padding:1.4mm 3.5mm 3.2mm;
  background:#fff;
}}
...
.patient-block{{margin-top:2.1mm;font-size:7.5pt}}
...
.rp-title{{font-family:Georgia,serif;font-size:13pt;font-weight:900;margin:1.7mm 0 .8mm}}
.rp{{height:108mm;padding:0 1mm;font-size:8pt;line-height:1.25;position:relative;z-index:2}}
...
.watermark{{
  position:absolute;left:50%;bottom:26mm;transform:translateX(-50%);
  width:55mm;opacity:.07;filter:saturate(.7);pointer-events:none;
}}
footer{{
  position:absolute;left:3.5mm;right:3.5mm;bottom:1.5mm;text-align:center;
  font-family:Georgia,serif;font-size:6.3pt;font-weight:700;line-height:1.17;
}}
.bottom-stripe{{
  position:absolute;left:0;right:0;bottom:-1.5mm;height:2.7mm;
  background:linear-gradient(90deg,var(--green) 0 55%,var(--blue) 55% 100%);
  border-radius:50% 50% 0 0 / 100% 100% 0 0;
}}
@page{{size:210mm 210mm;margin:0}}
@media print{{
  html,body{{width:210mm;height:210mm;background:#fff;padding:0}}
  .toolbar{{display:none!important}}
  .sheet{{width:210mm;height:210mm;margin:0;box-shadow:none}}
...
<div class='toolbar'>
  ...
  <span>Hoja 21 × 21 cm · 2 recetas iguales</span>
</div>

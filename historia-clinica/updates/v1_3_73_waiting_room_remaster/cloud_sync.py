...
class CloudSyncService:
    ...
    def _cycle(self):
        ...
        try:
            ...
            optional_backfill_queued = self._queue_missing_optional_rows(pg)
            ...
            _write_status(
                ...
                optional_cloud_backfill_queued=optional_backfill_queued,

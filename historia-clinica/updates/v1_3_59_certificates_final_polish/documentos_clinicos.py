...
.sheet{{width:216mm;min-height:279mm;margin:0 auto;background:#fff;padding:8mm 12mm 12mm;box-shadow:0 8px 28px #0f172a22}}
.brand-box{{height:38mm;border:1px solid #8fb3aa;border-radius:3mm;display:grid;grid-template-columns:25mm 1fr 28mm;align-items:center;gap:2mm;padding:2mm 3.5mm;position:relative;overflow:hidden}}
...
.brand-logo{{width:21mm;height:21mm;object-fit:contain;justify-self:center;z-index:2}}
.brand-copy{{text-align:center;z-index:2;line-height:1.08}}.brand-copy h1{{margin:0;font-size:15pt;font-weight:900}}.brand-copy h2{{margin:.6mm 0;font-size:12pt}}
.brand-meta{{font-size:7pt;font-weight:700;line-height:1.15}}
.cert-no{{z-index:2;text-align:center;font-size:8pt;font-weight:900;color:#173b66;align-self:end;padding-bottom:3mm}}
.title{{text-align:center;font-size:13pt;font-weight:900;margin:5mm 0 4mm;color:#173b66}}
.section-title{{font-weight:900;font-size:10.5pt;margin:4mm 0 2.5mm;border-bottom:.45mm solid #111;padding-bottom:1.2mm}}
.row{{display:grid;grid-template-columns:1fr 1fr;gap:7mm;margin:2.5mm 0;font-size:10.5pt}}
.line{{margin:2.2mm 0;font-size:10.2pt;line-height:1.32}}
.line b,.row b{{font-weight:900}}
.diagnosis-line{{margin:2.2mm 0;font-size:10.2pt;line-height:1.35}}.diagnosis-line span{{margin-left:4mm}}
.box{{display:inline-grid;place-items:center;width:7mm;height:7mm;border:.35mm solid #333;margin:0 1.5mm;font-weight:900}}
.disease-box{{display:grid;grid-template-columns:auto 1fr;gap:3mm;align-items:start;margin:3mm 0}}
.disease-text{{border:.35mm solid #555;min-height:22mm;padding:3mm;white-space:pre-wrap;font-size:10pt;line-height:1.3}}
.rest-line{{display:grid;grid-template-columns:42mm 1fr;gap:4mm;align-items:end;margin:5mm 0;font-size:10.5pt}}
.rest-value{{border-bottom:.45mm solid #111;padding:0 2mm 1.2mm;text-align:center;font-weight:700}}
.hint{{font-size:7.5pt;text-align:center;margin-top:.8mm}}
.signature-area{{width:78mm;margin:9mm auto 4mm;text-align:center;font-size:9pt;color:#1f2937}}
.signature-space{{height:17mm}}.signature-line{{border-top:.45mm solid #111;margin-bottom:2mm}}
.signature-area .doctor{{font-weight:900;font-size:10pt}}.signature-label{{margin-top:1.2mm;font-weight:800;font-size:8pt}}
.footer{{margin-top:4mm;border-top:.4mm solid #173b66;padding-top:2.5mm;font-size:7.5pt;text-align:center;color:#334155}}
@page{{size:Letter portrait;margin:0}}
@media print{{html,body{{width:216mm;height:279mm;background:#fff;padding:0}}.toolbar{{display:none}}.sheet{{margin:0;box-shadow:none;width:216mm;min-height:279mm}}}}
</style>
</head>
<body>
<div class='toolbar'><button onclick='window.print()'>Imprimir / Guardar PDF</button></div>

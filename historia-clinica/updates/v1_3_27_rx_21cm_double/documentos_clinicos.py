...
.rx-copy{{
  width:105mm;height:210mm;position:relative;overflow:hidden;padding:3mm 3.5mm 5mm;
  background:#fff;
}}
...
.patient-block{{margin-top:3.2mm;font-size:7.5pt}}
...
.rp{{height:87mm;padding:0 1mm;font-size:8pt;line-height:1.25;position:relative;z-index:2}}
...
.watermark{{
  position:absolute;left:50%;bottom:38mm;transform:translateX(-50%);
  width:55mm;opacity:.07;filter:saturate(.7);pointer-events:none;
}}
footer{{
  position:absolute;left:3.5mm;right:3.5mm;bottom:4.2mm;text-align:center;
  font-family:Georgia,serif;font-size:6.3pt;font-weight:700;line-height:1.17;
}}
.bottom-stripe{{
  position:absolute;left:0;right:0;bottom:-4.2mm;height:2.7mm;

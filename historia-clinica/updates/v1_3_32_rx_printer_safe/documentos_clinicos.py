...
.patient-block{{position:absolute;top:43mm;left:3.5mm;right:3.5mm;font-size:7.5pt}}
...
.rp-title{{position:absolute;top:73mm;left:3.5mm;font-family:Georgia,serif;font-size:13pt;font-weight:900;margin:0}}
.rp{{position:absolute;top:80mm;left:3.5mm;right:3.5mm;bottom:27mm;padding:0 1mm;font-size:8pt;line-height:1.25;z-index:2}}
...
.watermark{{
  position:absolute;left:50%;bottom:42mm;transform:translateX(-50%);
  width:55mm;height:auto;opacity:.07;filter:saturate(.7);pointer-events:none;
}}
footer{{
  position:absolute;left:3.5mm;right:3.5mm;bottom:4mm;text-align:center;

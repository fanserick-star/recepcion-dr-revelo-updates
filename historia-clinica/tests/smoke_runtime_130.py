...
ROOT = pathlib.Path(tempfile.gettempdir()) / "hc_runtime_smoke_130"
if ROOT.exists():
    shutil.rmtree(ROOT)
...
parts = [
    REPO / "historia-clinica/updates/v1_3_0_doctor_safety/app.py.part01",
    REPO / "historia-clinica/updates/v1_3_0_doctor_safety/app.py.part02",
    REPO / "historia-clinica/updates/v1_3_0_doctor_safety/app.py.part03",
    REPO / "historia-clinica/updates/v1_3_0_doctor_safety/app.py.part04",
]
...
shutil.copy2(
    REPO / "historia-clinica/updates/v1_3_0_doctor_safety/cloud_presence_patch.py",
    ROOT / "cloud_presence_patch.py",
)
shutil.copy2(
    REPO / "historia-clinica/updates/v1_3_0_doctor_safety/lan_bridge.py",
    ROOT / "lan_bridge.py",
)
...
assert app.APP_VERSION == "1.3.0", app.APP_VERSION
...
service = app.lan_bridge.LanService(ROOT, ROOT / "data" / "historia_clinica.db", "1.3.0", None)
...
print("APP_IMPORT_OK", app.APP_VERSION, "UPPERCASE_OK", "LAN_CANCEL_SAFE_OK")

...
parts = [
    REPO / "historia-clinica/updates/v1_2_5_hotfix/app.py.part01",
    REPO / "historia-clinica/updates/v1_2_5_hotfix/app.py.part02",
    REPO / "historia-clinica/updates/v1_2_5_hotfix/app.py.part03",
    REPO / "historia-clinica/updates/v1_2_5_hotfix/app.py.part04",
]
...
shutil.copy2(REPO / "historia-clinica/updates/v1_2_5_hotfix/cloud_presence_patch.py", ROOT / "cloud_presence_patch.py")
...
assert app.APP_VERSION == "1.2.5", app.APP_VERSION

...
function materializeCandidate(r,env){
  ...
  if(r.kind==="recordatorio_cita") return {...r,phone,template_name:env.TEMPLATE_RECORDATORIO_CITA||"recordatorio_cita",language:env.LANG_RECORDATORIO_CITA||"es_ES",body_params:[name,recordatorioDateTimeLabel(d,t)],buttons:[`CONFIRMAR|${r.source_type}|${r.source_id}|${d}|${t}`,`CANCELAR|${r.source_type}|${r.source_id}|${d}|${t}`],header_image_url};

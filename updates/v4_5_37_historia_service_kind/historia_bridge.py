    ...
    try:
        ...
        cur.execute(
            ...
            INSERT INTO waiting_queue(
              ...
              display_name,identification,attention_type,patient_status,queued_at,status,source,created_at,updated_at
            ) VALUES(%s,%s,%s,%s,%s,%s,%s,%s,%s,'waiting','reception',%s,%s)
            ...
            (queue_id, event_id, reception_patient_id, clinical_id, display_name,
             identification or None, attention_type, patient_status or None, queued_at, now, now),
        )
        conn.commit()
    finally:
        try: cur.close()

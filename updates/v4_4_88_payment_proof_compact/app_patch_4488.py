...
# v4.4.88 — comprobante de pago más limpio.
# - Retira las líneas visuales "PAGADO" y "Gracias por su confianza."
# - Mantiene el aviso inferior de que no reemplaza la factura electrónica.
# - Conserva márgenes, valores, forma de pago y diseño aprobado de v4.4.88.
# - No cambia BD, Neon, AZUR, Agenda, atenciones, recibo clínico ni facturación.

import re as _re

import app_patch_4487 as previous
...
try:
    ...
    def _print_payment_proof_windows_v4488(
        *,
        patient_name: str,
        proof_ref: str,
        service_date,
        ...
        doc.DefaultPageSettings.PaperSize = PaperSize(
            "Comprobante 80 mm",
            315,
            max(380, min(900, int(estimated_h))),
        )
...
def v4488_health(user=core.Depends(core.current_user)):
    return {
        ...
        "concept_bold": True,
        "removed_paid_label": True,
        "removed_thank_you": True,
        "legal_footer_preserved": True,

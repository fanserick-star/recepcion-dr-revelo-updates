...
try:
    ...
    def _thermal_logo_v4466(path):
        ...
        try:
            ...
            max_x = max_y = -1
            # Un muestreo completo es aceptable: el logo es pequeño y esto se hace
            # solo al generar un recibo.
            ...
            try:
                ...
                g.Dispose()
            # Umbral final: cero grises, solo negro/blanco.
    ...
    def _render_receipt_png_v4466(payload, show_blood_pressure=True):
        ...
        from System.Drawing import (
            Bitmap, Graphics, Color, Font, FontStyle, GraphicsUnit,
            Brushes, Pen, Rectangle, RectangleF, StringFormat, StringAlignment
        )  # type: ignore
        ...
        try:
            ...
            dotted = Pen(Color.FromArgb(80, 80, 80), 1.5); dotted.DashStyle = DashStyle.Dot
            ...
            # Crop to exact content height so both print paths have identical aspect ratio.
    ...
    def _print_receipt_windows_v4466(payload, printer_name: str = "", show_blood_pressure: bool = True) -> str:
        ...
        doc = PrintDocument(); doc.PrinterSettings.PrinterName = chosen
        ...
        def on_print_page(sender, e):
            ...
            # 72 mm sobre papel de 80 mm: 4 mm seguros por lado.
            target_w = 283.5

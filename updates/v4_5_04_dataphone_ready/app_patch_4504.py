...
;(()=>{
 ...
 const money=n=>' function box(){return document.querySelector('.attention-form-modal')||[...document.querySelectorAll('#modal .modalbox,.modal .modalbox,.modalbox')].find(b=>[...b.querySelectorAll('h1,h2,h3')].some(h=>norm(h.textContent)==='nueva atencion'))||null}
...
+Number(n||0).toFixed(2),key=(p,f)=>Number(p)+'|'+String(f||'').slice(0,10);

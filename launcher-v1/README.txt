LAUNCHER RECEPCIÓN - DR. ARMANDO REVELO v1.0.8

CONTENIDO
- INSTALAR_LAUNCHER_RECEPCION_DR_REVELO_V1_0_8.exe
...
- v1.0.8: actualizador silencioso sin consola y transición robusta del backend/puerto 8000.

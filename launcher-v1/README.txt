LAUNCHER RECEPCIÓN - DR. ARMANDO REVELO v1.0.7

CONTENIDO
- INSTALAR_LAUNCHER_RECEPCION_DR_REVELO_V1_0_7.exe
...
- v1.0.7: actualizador silencioso sin consola y transición robusta del backend/puerto 8000.
